<section class="bg-white dark:bg-gray-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6 ">
        ...
        <div class="grid grid-cols-2 gap-4 mt-8 cursor-pointer filter grayscale hover:grayscale-0">


            <img class="w-full rounded-lg" src="{{ Storage::url('' . $galleries[rand(0, 9)]->image) }}"
                alt="office content 1">

            <img class="mt-4 w-full lg:mt-10 rounded-lg cursor-pointer filter grayscale hover:grayscale-0"
                src="{{ Storage::url('' . $galleries[rand(0, 9)]->image) }}" alt="office content 2">
